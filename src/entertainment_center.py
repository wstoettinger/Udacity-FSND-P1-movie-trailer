...
mSteveJobs = media.Movie(
    "Steve Jobs",
    "Awesome Movie about Steve Jobs",
    "http://www.patentlyapple.com/.a/6a0120a5580826970c01b8d115b9de970c-800wi",  # noqa
...
mSteveJobs.producers.extend(
    ["Danny Boyle",
     "Guymon Casady",
     "Christian Colson",
     "Mark Gordon",
     "Scott Rudin"])
mSteveJobs.actors.extend(
    ["Michael Fassbender",
     "Kate Winslet",
     "Seth Rogen",
     "Jeff Daniels"])
