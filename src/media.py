...
class Movie():  # defining the Movie class
    __doc__ = "This is a container class which represents data of a movie"
    ...
    def __init__(self, title, storyline, poster_image, youtube_trailer):
        ...
        self.wikipedia_url = ""
        self.director = ""
        # creating two empty lists here which can be extenden from
        # outside the module/class
        self.producers = []
        self.actors = []
